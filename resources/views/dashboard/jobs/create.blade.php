...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{route('dashboard.jobs.create')}}">@lang('lang.create') @lang('lang.job')</a></li>
      </ol>
    </nav>
...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">@lang('lang.create') @lang('lang.job')</h4>
            <form class="forms-sample" method="POST" action="{{route('dashboard.jobs.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputName1">@lang('lang.name')</label>
                            <input type="text" class="form-control" name="name" id="exampleInputName1" value="{{old('display_name')}}" placeholder="@lang('lang.name')">
                            @error('name')
